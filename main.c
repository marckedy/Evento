...
void Lista(){
    ...
    while(nm3<(nm2+1)){
        ...
        printf("%d:",leer[nm3].hora);
        Minuts(leer[nm3].minuto);
        printf("%d\t\t%s\n",leer[nm3].minuto,leer[nm3].evento);
...
void Nevento(){
    ...
    while(feof(archivo)==0){
        ...
        if (strcmp(nombre, leer[nm].evento)==0){
            ...
            printf(" de %d\n",leer[nm].fecha.a);
            printf("HORA: %d:",leer[nm].hora);            
            Minuts(leer[nm].minuto);
            printf("%d hrs\n",leer[nm].minuto);
...
void Horario(){
    ...
    scanf("%c",&registro);
    scanf("%[^\n]",&nombre);
    archivo=fopen("miagenda.dat","r+d");
    while(feof(archivo)==0){
        fread(&leer[nm],sizeof(leer[nm]),1,archivo);
        if (strcmp(nombre, leer[nm].evento)==0){
...
void Eliminar(){
    ...
    while(feof(archivo)==0){
        ...
        if (strcmp(nombre, leer[nm].evento)==0){
            ...
            printf("%d\n\n",leer[nm].minuto);
            nuevo:
            printf("¿Está seguro de eliminar este evento?\n");
            printf("1. Si\n2. No\n");
            scanf("%d",&decidir);
            if((decidir<1)||(decidir>2)){
